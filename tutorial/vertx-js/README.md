...
1. You'd better install _org.apache.thrift~libthrift-vertx-js~1.0-SNAPSHOT_ into your local repo, because it may not in the public repos right now. Fire up your console, navigate to _lib/vertx-js_ folder, run
```
mvn install
```
2. Navigate to _tutorial/vertx-js-tutorial-server_, run
```
mvn install
mvn vertx:runMod
```
to start up the server.
3. Navigate to _tutorial/vertx-js-tutorial-client_, run
```
mvn install
mvn vertx:runMod
```
