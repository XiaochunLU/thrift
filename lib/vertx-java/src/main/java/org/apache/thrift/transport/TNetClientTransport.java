...
public class TNetClientTransport extends TClientSocketBasedTransport {

  private static final Logger LOGGER = LoggerFactory.getLogger(TNetClientTransport.class.getName());
  ...
  public TNetClientTransport(Args args) {
    super(args);
    args_ = args;
  }
