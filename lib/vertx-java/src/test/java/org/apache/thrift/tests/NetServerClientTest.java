...
import org.apache.thrift.tests.peer.NetTestClient;
import org.apache.thrift.tests.peer.NetTestServer;
import org.junit.Test;
import org.vertx.java.testframework.TestBase;


public class NetServerClientTest extends TestBase {
  ...
  private void testPeer(String serverAction, String clientAction, boolean serverOnWorker) {
    ...
    try {
      serverDeployId = startApp(serverOnWorker, NetTestServer.class.getName());
      clientDeployId = startApp(NetTestClient.class.getName());
    } catch (Exception e) {
      e.printStackTrace();
    }
